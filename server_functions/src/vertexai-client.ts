...
const FIRST_INTERVIEW_PRESETS: PresetConfig[] = [
    {
      ...
      imageUrl: process.env.FIRST_INTERVIEWER_1 || "",
    },
    {
      textToSpeechConfig: {
        ssmlGender: "FEMALE",
      ...
      imageUrl: process.env.FIRST_INTERVIEWER_2 || "",
    },
  ];
  ...
  const SECOND_INTERVIEW_PRESETS: PresetConfig[] = [
    {
      ...
      imageUrl: process.env.SECOND_INTERVIEWER_1 || "",
    },
    {
      textToSpeechConfig: {
        ssmlGender: "FEMALE",
      ...
      imageUrl: process.env.SECOND_INTERVIEWER_2 || "",
    },
  ];
  ...
  const FINAL_INTERVIEW_PRESETS: PresetConfig[] = [
    {
      ...
      imageUrl: process.env.FINAL_INTERVIEWER_1 || "",
    },
    {
      textToSpeechConfig: {
        ssmlGender: "FEMALE",
      ...
      imageUrl: process.env.FINAL_INTERVIEWER_2 || "",
    },
  ];
